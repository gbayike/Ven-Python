...
def emotion_detection():
    ...
    cap = cv2.imread("images/ezlocfvam39qkcjnce.jpg")
    ...
    for (x, y, w, h) in faces:
        ...
        if np.sum([roi_gray]) != 0:
            ...
            label_position = (x, y)
            cv2.putText(cap, label, label_position, cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            ...
            cv2.putText(cap, 'No Face Found', (20, 20), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 255, 0), 3)
